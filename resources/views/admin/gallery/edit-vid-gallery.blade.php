        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="panel">
                    ...
                    <form action="{{route('galVideo.update', $galVideo->id)}}" method="post" enctype="multipart/form-data">
                        @csrf
                            @method('PUT')
                        <div class="panel-body">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="far fa-images"></i></span>
                                <input class="form-control" placeholder="Video Name" type="text" name="video_name" value="{{$galVideo->video_name}}">
                            </div>
                            @error('video_name')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <div class="input-group">
                                ...
                                <input class="form-control" placeholder="Video Link" type="text" name="video_link" value="{{$galVideo->video_link}}">
                            </div>
                            @error('video_link')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                            ...
                            <br>
                            <video width="290" height="250" controls>
                                <source src="/storage/gallery_vidoes/{{$galVideo->video_name}}" type="file">
                            </video>
                            <br>
                            @error('video_image')
                            <div class="text-danger">{{ $message }}</div>
